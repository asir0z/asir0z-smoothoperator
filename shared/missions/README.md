...
| [MAC-2](MAC-2-DEVELOPMENT-EXPERIENCE.md) | **DEFERRED** · scope + baseline **Approved** | Complete engineering workstation (after Arch bootstrap) |
...
| [MAC-2 software baseline](MAC-2-SOFTWARE-BASELINE.md) | **Approved** | Ghostty · Spark · Brewfile set · no implementation yet |
