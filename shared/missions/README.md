...
| [MAC-2](MAC-2-DEVELOPMENT-EXPERIENCE.md) | **DEFERRED** · **DESIGN FROZEN** | Implementation after Arch bootstrap |
...
| [MAC-2 software baseline](MAC-2-SOFTWARE-BASELINE.md) | **Approved · frozen** | Ghostty · Spark · Brewfile set |
